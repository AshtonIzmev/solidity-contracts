...
contract DAT is GenericProduct {
    ...
    function subscribe(uint256 depositAmount, uint256 dayDuration, uint16 interestRate) public virtual {
        ...
        _subscriptions[tokenId] = Product(medToken.daysElapsed(), dayDuration, interestRate, depositAmount);
    ...
    function getProduct(uint256 tokenId) public view virtual returns (uint256, uint256, uint16, uint256) {
        return (
